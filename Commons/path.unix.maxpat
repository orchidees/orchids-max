{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 146.0, 231.0, 354.0, 310.0 ],
		"bglocked" : 0,
		"defrect" : [ 146.0, 231.0, 354.0, 310.0 ],
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "/Volumes/Filoops/Wicked",
					"fontsize" : 12.0,
					"numinlets" : 2,
					"numoutlets" : 1,
					"patching_rect" : [ 12.0, 226.0, 145.0, 18.0 ],
					"id" : "obj-9",
					"fontname" : "Arial",
					"outlettype" : [ "" ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-9", 1 ],
					"hidden" : 0,
					"midpoints" : [ 208.5, 214.0, 147.5, 214.0 ]
				}
